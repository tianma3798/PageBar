<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="default2.aspx.cs" Inherits="Page4._0.Example.default2" %>
        ...
        <div style="width:500px;margin:auto; margin-top:50px;">
            ...
            <script type="text/javascript">
                var pageOne = $('#pageOne').pageBar({
                    ...
                    showGoBtn:false, //不显示跳转按钮
                    //showAll:false, //显示跳转按钮，不显示数据总量
